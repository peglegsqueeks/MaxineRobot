        ...
        try:
            for i, scan in enumerate(lidar.iter_scans()):
                ...
                if current_time - start_time > max_time:
                    print(f"✓ Completed after {max_time} seconds (timeout)")
                    break
                ...
                if distances:
                    ...
                    print(f"Scan {scan_count:2d}: {valid_points:3d} points, "
                          f"Range: {min_dist:6.0f}-{max_dist:6.0f}mm, "
                          f"Avg: {avg_dist:6.0f}mm")
                else:
                    print(f"Scan {scan_count:2d}: No valid points")
                ...
                if scan_count >= 5 and len(scan_data) > 100:
                    print("✓ Collected sufficient scan data")
                    break
