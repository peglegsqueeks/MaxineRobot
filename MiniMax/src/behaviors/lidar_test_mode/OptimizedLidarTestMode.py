        ...
        try:
            ...
            with open(self.csv_log_filename, 'a', newline='') as csvfile:
                ...
                writer.writerow([
                    ...
                    person_data['x_camera'], person_data['z_camera'], person_data.get('confidence', 0.0),
                    ...
                    self.classify_stability(self.current_std_dev_pixels), head_angle_deg, head_tracking_active
                ])
        except Exception:
            pass
