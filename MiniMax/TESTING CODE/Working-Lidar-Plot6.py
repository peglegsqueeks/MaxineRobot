...
class SimpleLidarSystem:
    def __init__(self, port='/dev/ttyUSB0', baudrate=256000):
        ...
        # Enhanced persistent obstacle map with confidence scoring
        self.obstacle_confidence = {}  # Dict: {(angle_bin, distance_bin): confidence_score}
        self.scan_cycle_count = 0
        self.angle_resolution = 1.0  # 1 degree bins
        self.distance_resolution = 30  # 30mm bins for finer resolution
        
        # Stability parameters
        self.confidence_threshold = 0.3  # Minimum confidence to display obstacle
        self.confidence_increment = 0.2  # How much confidence increases when obstacle is seen
        self.confidence_decay = 0.05     # How much confidence decreases when not seen
        self.max_confidence = 1.0        # Maximum confidence value
...
def simple_lidar_test():
    ...
    matplotlib_polar_axis.set_title("LiDAR - Confidence-Based Stable Map", fontsize=11)
