            ...
            try:
                ...
                if measurement:
                    ...
                    try:
                        ...
                        # Debug: print first few measurements
                        if consecutive_failures == 0 and hasattr(self, '_debug_count'):
                            if not hasattr(self, '_debug_count'):
                                self._debug_count = 0
                            if self._debug_count < 5:
                                print(f"Debug measurement {self._debug_count}: quality={quality}, angle={angle}, distance={distance}")
                                self._debug_count += 1
                        ...
                        print(f"Measurement object: {measurement}")
                        print(f"Measurement type: {type(measurement)}")
                        print(f"Measurement dir: {dir(measurement)}")
                        continue
                else:
...
class StableLidarSystem:
                        ...
                        if scan_data and len(scan_data) > 0:
                            ...
                            if len(obstacles) > 0:
                                ...
                                if current_time - self.last_fps_time >= 1.0:
                                    ...
                                    print(f"Scan rate: {self.fps:.1f} Hz")
    ...
    def update_visualization(self, fig, polar_ax, scan_plot):
        ...
        try:
            ...
            if obstacles:
                ...
                polar_ax.set_title(f"LiDAR - {len(obstacles)} points", fontsize=10)
        ...
        if lidar_system.start():
            ...
            while True:
                ...
                if current_time - last_update >= update_interval:
                    if lidar_system.update_visualization(fig, polar_ax, scan_plot):
