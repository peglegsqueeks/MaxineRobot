...
class UltraBorg:
    ...
    def RawRead(self, command, length, retryCount=1):
        """
    ...
    def Init(self, tryOtherBus=False):
        ...
        self.PWM_MIN_1 = self.GetWithRetry(self.GetServoMinimum1, 1)
        self.PWM_MAX_1 = self.GetWithRetry(self.GetServoMaximum1, 1)
        self.PWM_MIN_2 = self.GetWithRetry(self.GetServoMinimum2, 1)
        self.PWM_MAX_2 = self.GetWithRetry(self.GetServoMaximum2, 1)
        self.PWM_MIN_3 = self.GetWithRetry(self.GetServoMinimum3, 1)
        self.PWM_MAX_3 = self.GetWithRetry(self.GetServoMaximum3, 1)
        self.PWM_MIN_4 = self.GetWithRetry(self.GetServoMinimum4, 1)
        self.PWM_MAX_4 = self.GetWithRetry(self.GetServoMaximum4, 1)
