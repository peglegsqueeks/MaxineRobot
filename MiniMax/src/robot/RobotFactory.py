...
class RobotFactory:
    ...
    def build_robot(self) -> Robot:
        ...
        CAMERA SENSOR DISABLED: No camera sensor to prevent threading conflicts
        """
        ...
        # DISABLED: No camera sensor to prevent threading conflicts with DirectPipelineLidarTest
        # camera_sensor = self.build_camera_sensor()  # REMOVED
        camera_sensor = None  # DISABLED - DirectPipelineLidarTest will handle camera directly
        print("📷 Camera sensor DISABLED - DirectPipelineLidarTest will handle camera access")
        ...
        return Robot(
            ...
            distance_sensor,
            camera_sensor,  # This is now None
            lidar_sensor,
            self.errors_occurred
        )
    ...
    def build_camera_sensor(self) -> CameraSensor:
        """
        DISABLED: Builds the camera sensor
        This method is kept for compatibility but now returns None
        DirectPipelineLidarTest will handle camera access directly
        """
        print("📷 build_camera_sensor() called but DISABLED - returning None")
