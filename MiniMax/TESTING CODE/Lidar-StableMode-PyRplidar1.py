...
class StableRPLidar:
    ...
    def start(self):
        ...
        print(f"Connected to RPLidar A3: {device_info}")
        ...
        stability_mode = next((m for m in scan_modes if "stability" in m['scan_mode'] or m['scan_mode'] == 'Sensitivity' or m['scan_mode'] == 'Stability'), scan_modes[0])
